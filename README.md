This stacked area chart is constructed from a TSV file storing the market share of several popular web browsers over the last year. The chart employs [conventional margins](http://bl.ocks.org/3019563) and a number of D3 features:
